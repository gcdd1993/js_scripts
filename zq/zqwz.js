...
【rewrite】
文章
https://kandian.wkandian.com/v5/article/info.json 重写目标 https://raw.githubusercontent.com/gcdd1993/My-Scripts/shaolin_kongfu/zq/zqwz.js
视频
https://kandian.wkandian.com/v5/article/detail.json 重写目标 https://raw.githubusercontent.com/gcdd1993/My-Scripts/shaolin_kongfu/zq/zqwz.js
时长
https://kandian.wkandian.com/v5/user/stay.json 重写目标 https://raw.githubusercontent.com/gcdd1993/My-Scripts/shaolin_kongfu/zq/zqwz.js
...
!(async () => {
    if (typeof $request !== "undefined") {
        ...
        let index1 = indexLast * 1
        // 每次阅读不超过180个
        let maxLength = zqwzbodyArr.length
        let k = index1 ? index1 : 0
        if (maxLength - k > maxReadNum) {
            maxLength = k + maxReadNum
        }
        for (k; k < maxLength; k++) {
            // $.message = ""
